...
void main() {
  group('PathConverter.fromLine', () {
    test('converts a line', () {
      ...
      final result = PathConverter.fromLine(element.getElement('line')!);
      expect(
  ...
  group('PathConverter.fromRect', () {
    test('converts a rect with no x & y', () {
      ...
      final result = PathConverter.fromRect(element.getElement('rect')!);
      expect(
        result.toXmlString(pretty: true),
  ...
  group('PathConverter.fromCircle', () {
    test('converts a circle', () {
      ...
      final result = PathConverter.fromCircle(element.getElement('circle')!);
      expect(
        result.toXmlString(pretty: true),
  ...
  group('PathConverter.fromEllipse', () {
    test('converts an ellipse', () {
      ...
      final result = PathConverter.fromEllipse(element.getElement('ellipse')!);
      expect(
        result.toXmlString(pretty: true),
  ...
  group('PathConverter.fromPoly', () {
    test('converts a polygon', () {
      ...
      final result = PathConverter.fromPoly(element.getElement('polygon')!);
      expect(
        result.toXmlString(pretty: true),
    ...
    test('converts a polyline', () {
      ...
      final result = PathConverter.fromPoly(
